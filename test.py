...
streambot5 = StreamBot(os.getenv('OPENAI_KEY'), "Paisley", genesis_prompt=constants.OPENAI_PROMPT[4])

#Prompt 5 - Pre-Listing Bot
streambot6 = StreamBot(os.getenv('OPENAI_KEY'), "Paisley", genesis_prompt=constants.OPENAI_PROMPT[5])


api = StreamBotAPI([streambot1,streambot2, streambot3, streambot4, streambot5, streambot6], origins=["http://localhost:3000","https://paisley-ui-hycvm.ondigitalocean.app"], verbosity=1, debug=True, port=8008, allow_model_override=True)
